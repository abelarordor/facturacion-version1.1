        ...
        <thead>
         ...
         <?php
              ...
              if ($busqueda=='administrador') {
               ...
               $sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM usuario u WHERE(u.idusuario LIKE'%$busqueda%' OR 
               u.nombre LIKE '%$busqueda%' OR 
               u.correo LIKE'%$busqueda%' OR 
               u.usuario like '%$busqueda%' $rol )AND estatus =1");
